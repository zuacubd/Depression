...
if __name__ == '__main__':
        ...
        prediction_test_dir = os.path.join(root_dir, "prediction", str(year), ml, "test", pretrained, model_state, dist)
        if cumulative == 1:
