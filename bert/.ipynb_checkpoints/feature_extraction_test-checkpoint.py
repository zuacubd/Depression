...
def vectorize(data):
    ...
    for user in data:
        ...
        for writing in m:
            ...
            encoded_input = tokenizer(text, truncation=True, truncation_strategy='only_first', max_length=128, return_tensors='pt')
...
if __name__ == '__main__':
    ...
    for i in range(1,11):
        ...
        for vect in vector_test:
            chemin = "/projets/sig/mullah/nlp/depression/features/"+str(year)+"/test/bert/"+vect["uid"]+".csv"
