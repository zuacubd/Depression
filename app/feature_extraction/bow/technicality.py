...
def get_technical_tokens(resources_dir):
    technical_tokens = []
    filename = os.path.join(resources_dir, "technical_words.txt")
...
class Technicality:
    ...
    def __init__(self, resources_dir):
        ...
        self.technical_items = get_technical_tokens(self.resources_dir)
        self.text = ""
        self.tokens = []
