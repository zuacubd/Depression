...
from criterias.stop_words import get_stop_words

def get_controversial_tokens(resources_dir):
    controversial_tokens = []
    filename = os.path.join(resources_dir, "controversial_topics.txt")
...
class Controversy:
    ...
    def __init__(self, resources_dir):
        ...
        self.controversial_items = get_controversial_tokens(self.resources_dir)
        self.text = ""
        self.tokens = []
