...
from app.data_loader.load import *
#cwd = os.getcwd()
...
if __name__ == '__main__':
    ...
    data_raw_train_dir = dataPath.get_data_raw_train_dir()
    data_raw_train_neg_dir = os.path.join(data_raw_train_dir, 'negative_examples_anonymous_chunks')
    data_raw_train_pos_dir = os.path.join(data_raw_train_dir, 'positive_examples_anonymous_chunks')

    traindata = load_train_data(chunks, data_raw_train_neg_dir, data_raw_train_pos_dir)
    print ("Total train users: {}".format(len(traindata)))
    print (traindata[0])

    data_raw_test_dir = dataPath.get_data_raw_test_dir()
    testdata = load_test_data(chunks, track_year, data_raw_test_dir)
    print ("Total test users:{}".format(len(testdata)))
    print (testdata[0])
